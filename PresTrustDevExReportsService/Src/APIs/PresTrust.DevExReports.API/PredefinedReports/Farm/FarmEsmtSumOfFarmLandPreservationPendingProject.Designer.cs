...
namespace PresTrust.DevExReports.API.PredefinedReports.Farm {
    ...
    public partial class FarmEsmtSumOfFarmLandPreservationPendingProject : DevExpress.XtraReports.UI.XtraReport {
        private void InitializeComponent() {
            DevExpress.XtraReports.ReportInitializer reportInitializer = new DevExpress.XtraReports.ReportInitializer(this, "PresTrust.DevExReports.API.PredefinedReports.Farm.FarmEsmtSumOfFarmLandPreservati" +
                    "onPendingProject.repx");
