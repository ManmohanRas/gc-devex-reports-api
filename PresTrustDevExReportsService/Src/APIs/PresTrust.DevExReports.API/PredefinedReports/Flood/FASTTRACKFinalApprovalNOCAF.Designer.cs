...
namespace PresTrust.DevExReports.API.PredefinedReports.Flood {
    ...
    public partial class FASTTRACKFinalApprovalNOCAF : DevExpress.XtraReports.UI.XtraReport {
        private void InitializeComponent() {
            DevExpress.XtraReports.ReportInitializer reportInitializer = new DevExpress.XtraReports.ReportInitializer(this, "PresTrust.DevExReports.API.PredefinedReports.Flood.FASTTRACKFinalApprovalNOCAF.re" +
                    "px");
